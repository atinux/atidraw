...
export default eventHandler(async (event) => {
  ...
  res.blobs = res.blobs.map(b => ({
    ...
    customMetadata: {
      ...
      aiImage: b.customMetadata?.aiImage || b.customMetadata?.aiimage || b.customMetadata?.ai_image,
      aiImageUrl: b.customMetadata?.aiImageUrl || b.customMetadata?.aiimageurl || b.customMetadata?.ai_image_url,
    },
  }))
